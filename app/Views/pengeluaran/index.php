...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Pengeluaran MH Laundry</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-success"> Daftar Pengeluaran</h6>
            <a href="/pengeluaran/create" class="d-none float-right d-sm-inline-block btn btn-sm btn-info shadow-sm"><i
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php foreach ($joinakun->getResult() as $p) : ?>
