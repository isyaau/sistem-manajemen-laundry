...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Ubah Laundry Satuan</h6>

        </div>
        <div class="card-body">
            <div>
                <form action="/satuan/update/<?= $satuan['id_laundry']; ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <input type="hidden" name="id_laundry"
                        value="<?= (old('id_laundry')) ? old('id_laundry') : $satuan['id_laundry'];?>">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input name="jenis_laundry" type="text" id="jenis_laundry" class="form-control"
                                value="<?= (old('jenis_laundry')) ? old('jenis_laundry') : $satuan['jenis_laundry'];?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input name="harga" type="text" class="form-control" id="harga"
                                value="<?= (old('harga')) ? old('harga') : $satuan['harga'];?>">
                            <div class="invalid-feedback">
