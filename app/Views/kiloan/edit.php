...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Ubah Laundry Kiloan</h6>

        </div>
        <div class="card-body">
            <div>
                <form action="/kiloan/update/<?= $kiloan['id_laundry']; ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <input type="hidden" name="id_laundry"
                        value="<?= (old('id_laundry')) ? old('id_laundry') : $kiloan['id_laundry'];?>">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input name="jenis_laundry" type="text" id="jenis_laundry" class="form-control"
                                value="<?= (old('jenis_laundry')) ? old('jenis_laundry') : $kiloan['jenis_laundry'];?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input name="harga" type="text" class="form-control" id="harga"
                                value="<?= (old('harga')) ? old('harga') : $kiloan['harga'];?>">
                            <div class="invalid-feedback">
                    ...
                    <div>
                        ...
                        <a href="/kiloan" class="btn btn-success  float-right">Kembali</a>
