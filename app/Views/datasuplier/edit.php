...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div>
                <form action="/datasuplier/update/<?= $datasuplier['id_suplier']; ?>" method="post"
                    enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <input type="hidden" name="id_suplier"
                        value="<?= (old('id_suplier')) ? old('id_suplier') : $datasuplier['id_suplier'];?>">
                    <div class="form-group row">
                        <label for="nama_suplier" class="col-sm-2 col-form-label">Nama Suplier</label>
                        <div class="col-sm-5">
                            <input name="nama_suplier" type="text" id="nama_suplier" class="form-control"
                                value="<?= (old('nama_suplier')) ? old('nama_suplier') : $datasuplier['nama_suplier'];?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input name="alamat_suplier" type="text" class="form-control" id="alamat_suplier"
                                value="<?= (old('alamat_suplier')) ? old('alamat_suplier') : $datasuplier['alamat_suplier'];?>">
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input name="email" type="text" class="form-control" id="email"
                                value="<?= (old('email')) ? old('email') : $datasuplier['email'];?>">
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input name="no_hp" type="text" class="form-control" id="no_hp"
                                value="<?= (old('no_hp')) ? old('no_hp') : $datasuplier['no_hp'];?>">
                            <div class="invalid-feedback">
